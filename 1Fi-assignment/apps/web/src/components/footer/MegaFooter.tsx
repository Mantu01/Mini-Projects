...
export function MegaFooter() {
  return (
    <footer className="mt-12 border-t bg-gray-50 px-4 py-8">
      <div className="max-w-7xl mx-auto">
        {/* Category link columns */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          {footerCategoryGroups.map((group) => (
            <div key={group.heading}>
              <h4 className="font-bold text-sm text-gray-900 mb-3">{group.heading}</h4>
              <ul className="space-y-2">
                {group.links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-xs text-gray-600 hover:text-orange-500">
                      {link}
                    </a>
                  </li>
                ))}
        ...
        <div className="mb-6 text-sm text-gray-600">
          <p className="font-bold text-gray-900">{companyInfo.legalName}</p>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          ...
          <div>
            <h4 className="font-bold text-sm text-gray-900 mb-3">Support Links</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t pt-6 mb-6">
          <h4 className="font-bold text-sm text-gray-900 mb-3">Download Snapmint Today</h4>
          <div className="flex gap-3">
            <a href="#" className="inline-flex items-center gap-2 rounded-full bg-gray-900 px-4 py-2 text-xs text-white hover:bg-gray-800">
        ...
        <div className="flex gap-4 mb-6">
          <a href={socialLinks.facebook} className="size-8 rounded-full bg-gray-200 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-colors">
          ...
          <a href={socialLinks.instagram} className="size-8 rounded-full bg-gray-200 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-colors">
          ...
          <a href={socialLinks.twitter} className="size-8 rounded-full bg-gray-200 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-colors">
          ...
          <a href={socialLinks.youtube} className="size-8 rounded-full bg-gray-200 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-colors">
        ...
        {/* Tagline */}
        <p className="text-center text-xs text-gray-400">Proudly made in India</p>
      </div>
    </footer>
  )
}
