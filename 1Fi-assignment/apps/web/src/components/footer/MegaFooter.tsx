    ...
    <footer className="mt-12 border-t bg-white px-4 py-8">
      <div className="max-w-7xl mx-auto">
            ...
            <div key={group.heading}>
              ...
              <ul className="space-y-2">
                {group.links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-xs text-muted-foreground hover:text-[#6C28D9]">
                      {link}
                    </a>
                  </li>
                ))}
        ...
        <div className="border-t py-4 mb-6">
          <a href="#" className="text-sm font-semibold text-[#6C28D9] hover:underline">
            1Fi for Business →
          </a>
        </div>
        ...
        <div className="flex gap-4 mb-6">
          <a href={socialLinks.facebook} className="size-8 rounded-full bg-muted flex items-center justify-center hover:bg-[#6C28D9] hover:text-white transition-colors">
          ...
          <a href={socialLinks.instagram} className="size-8 rounded-full bg-muted flex items-center justify-center hover:bg-[#6C28D9] hover:text-white transition-colors">
          ...
          <a href={socialLinks.twitter} className="size-8 rounded-full bg-muted flex items-center justify-center hover:bg-[#6C28D9] hover:text-white transition-colors">
          ...
          <a href={socialLinks.youtube} className="size-8 rounded-full bg-muted flex items-center justify-center hover:bg-[#6C28D9] hover:text-white transition-colors">
